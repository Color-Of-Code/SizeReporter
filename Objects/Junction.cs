...
namespace SizeReporter
{
    ...
    internal class Junction : IComparable
    {
        public Junction(String source)
        {
            Source = source;
        }
        ...
        public String Target { get { return GetTarget(Source); } }

        public int CompareTo(object obj)
        {
            return Source.CompareTo((obj as Junction).Source);
        }
    }
}
